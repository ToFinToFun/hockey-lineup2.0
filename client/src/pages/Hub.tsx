        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <Link href="/stats">
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a1a1a] to-[#111] border border-[#2a2a2a] hover:border-amber-500/60 transition-all duration-300 cursor-pointer">
              {/* Accent line */}
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-amber-500 to-amber-500/30 opacity-0 group-hover:opacity-100 transition-opacity" />

              <div className="p-5 sm:p-6 flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center">
                  <TrendingUp size={24} className="text-amber-500" />
                </div>
                <div className="flex-1 min-w-0">
                  <h2 className="text-lg sm:text-xl font-bold tracking-tight">Statistik</h2>
                  <p className="text-white/40 text-xs sm:text-sm mt-0.5">
                    Poängligan, utmärkelser och spelarstatistik
                  </p>
                  <div className="flex items-center gap-3 mt-2">
                    <span className="inline-flex items-center gap-1 text-[10px] text-white/30 bg-white/5 px-2 py-0.5 rounded-full">
                    ...
                    <span className="inline-flex items-center gap-1 text-[10px] text-white/30 bg-white/5 px-2 py-0.5 rounded-full">
                      <BarChart3 size={10} /> Poängligan
                    </span>
                  </div>
                </div>
                <ChevronRight
                  size={20}
                  className="text-white/20 group-hover:text-amber-500 transition-colors flex-shrink-0"
                />
              </div>
            </div>
          </Link>
          ...
          <Link href="/cards">
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a1a1a] to-[#111] border border-[#2a2a2a] hover:border-purple-500/60 transition-all duration-300 cursor-pointer">
              {/* Accent line */}
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-purple-500 to-purple-500/30 opacity-0 group-hover:opacity-100 transition-opacity" />

              <div className="p-5 sm:p-6 flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
